...
const Single_Product_Component = ({ img, price, title, dis_price ,man,quantity}) => {
    return (
        <Box bg={"#fff"} p={"15px"} borderRadius={"10px"} mb={'15px'}>
            ...
            <Box mb="10px" key={title}>
                <Flex >
                    ...
                    <Box ml="auto" w="90px" >
                        <Box ml="0px" >
                            <Text fontSize='16px' fontWeight={"bold"} color='#ef4281' >Rs.{price}</Text>
                            {dis_price && <Text mb='15px' color='#151B3999' fontWeight={'400'} textDecoration={'line-through'} fontSize={'12px'}>Rs.{500}</Text>}
