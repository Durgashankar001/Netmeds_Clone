...
const Single_Card_Component = ({name,price,img,cross_price}) => {
    return (
        <Box w={{ base: '100%' }}  p=' 10px' boxShadow='rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px' bg='#fff'>
            <Center><Image cursor='pointer'  src={img}></Image></Center>
            ...
            <Center><Button h='35px' borderRadius={'3px'} bg='#24aeb1' color='#fff' _hover={{ bg: '#24aeb1' }} fontSize='14px' w='100%'>ADD TO CART</Button></Center>
        </Box>
    )
}
